...
exports.login_tournaments = function(req, res, next) {
		...
		if(req.query.sort=="lowtohigh"){
			...
			if(req.session.message === undefined)
				req.session.message = "";
				var sql = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' order by registration_fee";
				db.query(sql, function(err, result){
					//console.log("Login Tournaments Team result 0");
					//console.log(result);
					var sql1 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' order by registration_fee";
					db.query(sql1, function(err, result1){
						//console.log("Login Tournaments Team result 1");
						var sql2 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like 'dota%' AND t.Status = 'Open' order by registration_fee";
						db.query(sql2, function(err, result2){
							//console.log("Login Tournaments Team result 2");
								var sql4 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'lol%\' AND t.Status = 'Open' order by registration_fee";
								db.query(sql4, function(err, result4){
									//console.log("Login Tournaments Team result 4");
									var sql5 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'cs%\' AND t.Status = 'Open' order by registration_fee";
									db.query(sql5, function(err, result5){
										//console.log("Login Tournaments Team result 5");
			...
			if(req.session.message === undefined)
				req.session.message = "";
				var sql = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' order by registration_fee desc";
				db.query(sql, function(err, result){
					//console.log("Login Tournaments Team result 0");
					//console.log(result);
					var sql1 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' order by registration_fee desc";
					db.query(sql1, function(err, result1){
						//console.log("Login Tournaments Team result 1");
						var sql2 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like 'dota%' AND t.Status = 'Open' order by registration_fee desc";
						db.query(sql2, function(err, result2){
							//console.log("Login Tournaments Team result 2");
								var sql4 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'lol%\' AND t.Status = 'Open' order by registration_fee desc";
								db.query(sql4, function(err, result4){
									//console.log("Login Tournaments Team result 4");
									var sql5 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'cs%\' AND t.Status = 'Open' order by registration_fee desc";
									db.query(sql5, function(err, result5){
										//console.log("Login Tournaments Team result 5");
			...
			if(req.session.message === undefined)
				req.session.message = "";
				var sql = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' and t.TournamentName like '%"+req.query.search+"%' order by TSched desc";
				db.query(sql, function(err, result){
					//console.log("Login Tournaments Team result 0");
					//console.log(result);
					var sql1 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' and t.TournamentName like '%"+req.query.search+"%' order by TSched desc";
					db.query(sql1, function(err, result1){
						//console.log("Login Tournaments Team result 1");
						var sql2 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like 'dota%' AND t.Status = 'Open' and t.TournamentName like '%"+req.query.search+"%' order by TSched desc";
						db.query(sql2, function(err, result2){
							//console.log("Login Tournaments Team result 2");
								var sql4 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'lol%\' AND t.Status = 'Open' and t.TournamentName like '%"+req.query.search+"%' order by TSched desc";
								db.query(sql4, function(err, result4){
									//console.log("Login Tournaments Team result 4");
									var sql5 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'cs%\' AND t.Status = 'Open' and t.TournamentName like '%"+req.query.search+"%' order by TSched desc";
									db.query(sql5, function(err, result5){
										//console.log("Login Tournaments Team result 5");
			...
			if(req.session.message === undefined)
				req.session.message = "";
				var sql = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' order by TSched desc";
				db.query(sql, function(err, result){
					//console.log("Login Tournaments Team result 0");
					//console.log(result);
					var sql1 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And t.Status = 'Open' order by TSched desc";
					db.query(sql1, function(err, result1){
						//console.log("Login Tournaments Team result 1");
						var sql2 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And like 'dota%' AND t.Status = 'Open' order by TSched desc";
						db.query(sql2, function(err, result2){
							//console.log("Login Tournaments Team result 2");
								var sql4 = "select td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'lol%\' AND t.Status = 'Open' order by TSched desc";
								db.query(sql4, function(err, result4){
									//console.log("Login Tournaments Team result 4");
									var sql5 = "Sselect td.tdetID, td.TournamentID, td.TournaRange, td.TSched, td.Max_participants, td.registration_fee, td.Tpic, td.1stPrize as first, td.2ndPrize as second, td.TVenue, t.TournamentName, t.TournamentGame, t.tournaLB, t.tournaUB, rt.registeredteams, t.Status from teampalak.registered_teams r inner join teampalak.members m on r.registeredteamid = m.teamid inner join teampalak.teams te on r.registeredteamid = te.teamid inner join teampalak.accounts acc on m.memid = acc.accid inner join teampalak.gameaccounts gacc on gacc.username = acc.username  inner join teampalak.tournaments t on r.tournamentID = t.tournamentID inner join teampalak.tournament_details td on r.tournamentID = td.tournamentID inner join (SELECT COUNT(registeredteamID) AS registeredteams, SUM(Seed) AS seed, tournament_details.TournamentID FROM tournament_details LEFT JOIN registered_teams ON tournament_details.TournamentID = registered_teams.TournamentID WHERE Status = 'Approved' GROUP BY TournamentID) rt ON td.TournamentID = rt.TournamentID  where gacc.ingamename in (select gacc.ingamename from teampalak.gameaccounts gacc where acc.accid  != "+userId+" ) And TournamentGame like \'cs%\' AND t.Status = 'Open' order by TSched desc";
									db.query(sql5, function(err, result5){
										//console.log("Login Tournaments Team result 5");
...
//==========================| Registered Tournaments Team |=============================
exports.registered_tournaments = function(req, res, next) {
		//console.log("a");
			var user = req.session.user,
				userId = req.session.userID;
			//console.log("b");
								...
								db.query(sql4, function(err, result4){
									...
									db.query(sql5, function(err, result5){
										//console.log("Login Tournaments Team result 5");
											...
											db.query(sql7, function(err, result7){
												//console.log("Login Tournaments Team result 7");
													res.render('registered_tournaments.ejs',{data:result,data1:result1,data2:result2, user: userId, message:message, lol:result4, dota:result5,  all:result7});
											})
